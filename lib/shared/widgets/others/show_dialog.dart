                  ...
                  children: [
                    ...
                    Expanded(
                      child: ButtonPrimary(
                        onPressed: onConfirm ?? () => Get.back(),
                        label: labelPositif ?? "Ya",
                        color: buttonColor ?? AppColor.redButton,
                        labelStyle: TextStyles.inter.copyWith(
                          fontSize: FontSizes.s14,
  ...
  Get.dialog(
    Dialog(
      insetPadding: EdgeInsets.symmetric(
          horizontal: Insets.icMenu, vertical: Insets.icMenu),
      backgroundColor: Colors.transparent,
      child: Container(
        padding: EdgeInsets.all(Insets.icMenu),
        decoration: BoxDecoration(
          borderRadius: Corners.lgBorder,
          color: cardColor ?? AppColor.primaryColor,
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          mainAxisSize: MainAxisSize.min,
          children: [
            icon ?? verticalSpace(0),
            verticalSpace(Insets.sm),
            Text(
              title,
              style: titleStyle ??
                  TextStyles.textBase.copyWith(
                    color: AppColor.primaryColor,
                    fontWeight: FontWeight.w500,
                  ),
            ),
            verticalSpace(Insets.lg),
            desc ?? verticalSpace(0),
            verticalSpace(Insets.med),
            input ?? verticalSpace(0),
            verticalSpace(Insets.icMenu),
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
              children: [
                Expanded(
                  child: ButtonText(
                    onPressed: onCancel != null
                        ...
                        : () => Get.back(),
                    label: labelCancel ?? 'Batal',
                    textStyle: TextStyles.textBase.copyWith(
                      height: 1.71,
                      fontWeight: FontWeight.w500,
                ...
                Expanded(
                  child: ButtonPrimary(
                    ...
                    onPressed: onConfirm != null
                        ...
                        : () => Get.back(),
                    label: labelButtonConfirm ?? 'Iya',
                    labelStyle: TextStyles.textBase.copyWith(
                      height: 1.71,
                      fontWeight: FontWeight.w500,
                    ),
                  ),
                ...
                Expanded(
                  child: ButtonPrimary(
                    ...
                    onPressed: onConfirm != null
                        ...
                        : () => Get.back(),
                    label: labelButtonConfirm ?? 'Mengerti',
                    labelStyle: TextStyles.textBase.copyWith(
                      height: 1.71,
                      fontWeight: FontWeight.w500,
                    ),
        ...
        child: Column(
          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                text:
                    'Anda tidak diperkenankan untuk memulai perjalanan Travel sebelum tanggal ',
                style: TextStyles.inter.copyWith(
                  fontSize: FontSizes.s12,
                  color: AppColor.neutral.shade800,
                ),
              ...
              children: [
                Expanded(
                  child: ButtonPrimaryOutline(
                    ...
                    outlineColor: AppColor.errorColor,
                    color: AppColor.whiteColor,
                    onPressed: onConfirm != null
                        ? () {
                            onConfirm();
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            verticalSpace(Insets.lg),
            Text(
              'Anda bisa membuka detail penumpang Travel jika tawaran anda telah disetujui oleh calon penumpang.',
              style: TextStyles.inter.copyWith(
                fontSize: FontSizes.s12,
                color: AppColor.neutral.shade800,
              ),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            verticalSpace(Insets.lg),
            Text(
              'Tidak ada penumpang pada perjalanan anda. Silakan hubungi admin untuk membatalkan perjalanan / transaksi ini.',
              style: TextStyles.inter.copyWith(
                fontSize: FontSizes.s12,
                color: AppColor.neutral.shade800,
              ),
              ...
              children: [
                Expanded(
                  child: ButtonPrimaryOutline(
                    height: 46.h,
                    borderRadius: Corners.xxl,
                    outlineColor: const Color(0xFFFBBD08),
                    color: AppColor.whiteColor,
                    onPressed: onConfirm != null
                        ? () {
                            onConfirm();
                ...
                Expanded(
                  child: ButtonPrimary(
                    ...
                    onPressed: onConfirm != null
                        ...
                        : () => Get.back(),
                    label: labelButtonConfirm ?? 'Akhiri',
                    labelStyle: TextStyles.textBase.copyWith(
                      height: 1.71,
                      fontWeight: FontWeight.w500,
                    ),
